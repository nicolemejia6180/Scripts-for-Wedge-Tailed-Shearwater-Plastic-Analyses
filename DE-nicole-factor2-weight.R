...
#
#save all in a pdf
pdf("WTSH-ALL-weight-2factor.pdf")
#
filePath <- "/n/holyscratch01/edwards_lab/nmejia/"
sampleNames <- c("SAMPLE-PREP0157_FTermREA12618A_C01v1_N003_S3_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C02v1_N012_S11_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D02v1_N013_S12_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E02v1_N014_S13_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G02v1_N016_S15_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D01v1_N005_S4_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B01v1_N002_S2_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C04v1_N028_S27_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H01v1_N009_S8_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F03v1_N023_S22_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F02v1_N015_S14_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G03v1_N024_S23_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H03v1_N025_S24_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H02v1_N017_S16_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E01v1_N006_S5_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G01v1_N008_S7_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A03v1_N018_S17_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E03v1_N022_S21_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D04v1_N029_S28_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B03v1_N019_S18_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D03v1_N021_S20_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A04v1_N026_S25_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B04v1_N027_S26_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F01v1_N007_S6_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C03v1_N020_S19_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A02v1_N010_S9_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B02v1_N011_S10_L004Aligned.toTranscriptome.out.bam")
#
...
sampleMetaData <- data.frame(weight=rep(c(rep(c("high"), 8),rep(c("low"),19)),1))
#
...
head(assay(rld), 3)
#estimate size factor and plot to compare log2 with normalized count, vsd and rlog methods
...
heat.colors <- brewer.pal(6, "YlOrRd")
pheatmap(norm_OEsig, cluster_rows = T, show_rownames=T,cluster_cols = F,
    annotation_col = as.data.frame(cdata),border_color=NA, fontsize = 5,
      fontsize_row = 5, height=100)
