...
#
#save all in a pdf
pdf("WTSH-ALL-weight-2factor-MALES.pdf")
#
filePath <- "/n/holyscratch01/edwards_lab/nmejia/"
sampleNames <- c("SAMPLE-PREP0157_FTermREA12618A_E02v1_N014_S13_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G02v1_N016_S15_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D01v1_N005_S4_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H02v1_N017_S16_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B03v1_N019_S18_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D03v1_N021_S20_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A04v1_N026_S25_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B04v1_N027_S26_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A02v1_N010_S9_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B02v1_N011_S10_L004Aligned.toTranscriptome.out.bam")
#
...
sampleMetaData <- data.frame(weight=rep(c(rep(c("high"), 3),rep(c("low"),7)),1))
#
