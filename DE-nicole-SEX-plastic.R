...
#
#save all in a pdf
pdf("WTSH-SEX-plastic.pdf")
#
filePath <- "/n/holyscratch01/edwards_lab/nmejia/"
sampleNames <- c("SAMPLE-PREP0157_FTermREA12618A_F02v1_N015_S14_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G03v1_N024_S23_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H03v1_N025_S24_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F01v1_N007_S6_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C03v1_N020_S19_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C04v1_N028_S27_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D01v1_N005_S4_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H02v1_N017_S16_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A02v1_N010_S9_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B02v1_N011_S10_L004Aligned.toTranscriptome.out.bam")
##prepare matrix
...
sampleMetaData <- data.frame(sex=rep(c(rep(c("females"), 6),rep(c("males"), 4)),1))
#
