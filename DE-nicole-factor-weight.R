...
#
#save all in a pdf
pdf("WTSH-ALL-weight-3factor.pdf")
#
filePath <- "/n/holyscratch01/edwards_lab/nmejia/"
sampleNames <- c("SAMPLE-PREP0157_FTermREA12618A_C01v1_N003_S3_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C02v1_N012_S11_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D02v1_N013_S12_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D01v1_N005_S4_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E02v1_N014_S13_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G02v1_N016_S15_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H01v1_N009_S8_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F02v1_N015_S14_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F03v1_N023_S22_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G03v1_N024_S23_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H03v1_N025_S24_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_H02v1_N017_S16_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B01v1_N002_S2_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E01v1_N006_S5_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_F01v1_N007_S6_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_G01v1_N008_S7_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A03v1_N018_S17_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C03v1_N020_S19_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_E03v1_N022_S21_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_C04v1_N028_S27_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D04v1_N029_S28_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A02v1_N010_S9_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B02v1_N011_S10_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B03v1_N019_S18_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_D03v1_N021_S20_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_A04v1_N026_S25_L004Aligned.toTranscriptome.out.bam","SAMPLE-PREP0157_FTermREA12618A_B04v1_N027_S26_L004Aligned.toTranscriptome.out.bam")
#
...
sampleMetaData <- data.frame(weight=rep(c(rep(c("high"), 6),rep(c("low"),6),rep(c("medium"), 15)),1))
#
#
rownames(sampleMetaData) <- sampleNames
rsem.in <- DESeqDataSetFromMatrix(countData = ct, colData = sampleMetaData, design = ~ weight, tidy = T)
...
rownames(sampleDistMatrix) <- paste( vsd$weight, vsd$sampleNames,sep = " - " )
...
res <- results(rsem.de, contrast=c("weight","low","high"))
...
plotCounts(rsem.de, gene = topGene, intgroup=c("weight"))
...
res <- lfcShrink(rsem.de, coef="weight_low_vs_high", type="apeglm")
...
res.noshr <- results(rsem.de, name="weight_low_vs_high")
...
#anno <- as.data.frame(colData(vsd)[, c("weight")])
cdata <- colData(vsd)
